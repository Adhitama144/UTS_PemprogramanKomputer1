...
public class Form extends javax.swing.JFrame {
    ...
    public Form() {
        ...
        try {
            ...
            conn = DriverManager.getConnection("jdbc:mysql://localhost/uts_22090071_C", "root", "");
            
            stmt = conn.createStatement();
            rs = stmt.executeQuery("SELECT * from tabel_22090071_C");
    ...
    private void initComponents() {
        ...
        jLabel5.getAccessibleContext().setAccessibleName("4. KATEGORI");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            stmt = conn.createStatement();
            stmt.executeUpdate("INSERT INTO tabel_22090071_C (nama_umkm, bidang, tahun_pendirian, kategori) VALUES ('" + nama.getText() + "','" + bidang.getSelectedItem() + "'," + tahun_pendirian.getText() + ",'" + kategori.getSelectedItem() + "')");
